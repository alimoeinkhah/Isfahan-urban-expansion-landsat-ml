...
dataset_path = ROOT / "data" / "training" / "2024" / "training_dataset_2024.csv"
model_dir = ROOT / "models" / "2024"
...
metrics.to_csv(tables_dir / "model_metrics_2024.csv", index=False)
...
figure.tight_layout()
figure.savefig(metrics_dir / "confusion_matrices_2024.png", dpi=300, bbox_inches="tight")
plt.show()
